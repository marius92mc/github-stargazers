...
class UsernameRepositoryError(Exception): 
    ...
    def __init__(self) -> None:
        return super().__init__("Argument should be of form username/repository.")
...
class GitHub:
    ...
    def __extract_user_and_repo(self, username_and_repository: str) -> typing.Optional[typing.Tuple[str, str]]:
